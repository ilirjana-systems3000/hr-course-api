    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    LeapProfileId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistrictCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    EmployeeCost = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Courses_DistrictId_CourseTypeId_Description",
                table: "Courses",
                columns: new[] { "DistrictId", "CourseTypeId", "Description" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CourseTypes_DistrictId_Description",
                table: "CourseTypes",
                columns: new[] { "DistrictId", "Description" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_DistrictId_Email",
                table: "Employees",
